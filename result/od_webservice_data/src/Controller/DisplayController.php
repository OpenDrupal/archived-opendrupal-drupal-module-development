...
use Drupal\od_webservice\HtmlLoader\HtmlLoader;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Class DisplayController.
 *
 * @package Drupal\od_webservice\Controller
 */
class DisplayController extends ControllerBase {
   ...
   * HTML Loader.
   *
   * @var \Drupal\od_webservice\HtmlLoader\HtmlLoader
   */
   ...
   *
   * @var \Drupal\od_webservice\HtmlProcessorBase
   */
   ...
   *
   * @param \Drupal\od_webservice\HtmlLoader\HtmlLoader $html_loader
  ...
  public function receivedData() {
    ...
    foreach ($entities as $entity) {
      ...
      foreach ($entity->getProcessors() as $plugin_id) {
        ...
        /** @var \Drupal\od_webservice\HtmlProcessorInterface $processor */
